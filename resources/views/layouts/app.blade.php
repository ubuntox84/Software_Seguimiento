...
<body class="h-full" scroll-region>
  <div 
  x-data="{
    mobileShowHidden:true,
    {{-- profileShowHidden:false, --}}
    profileMobileShowHidden:false,
  ...
  <!-- Page Heading -->
  @if (isset($header))
  <header class="bg-white shadow lg:pl-64">
...
@endif
  ...
  @livewireScripts
  <footer class="bg-white lg:pl-64">
  <div class="mx-auto max-w-7xl py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
    ...
    <div class="mt-8 md:order-1 md:mt-0">
      <p class="text-center text-xs leading-5 text-gray-500">&copy; {{ now()->year }} Your Company, Inc. All rights reserved.</p>
    </div>
  </div>
</footer>
