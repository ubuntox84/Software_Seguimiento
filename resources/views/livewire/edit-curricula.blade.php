  <div 
            ...
            x-init="
            window.livewire.on('hiddenFormEdit', () => {
            ...
            window.livewire.on('showFormEdit', () => {
                
                showFormEditAlp = true
            ...
            class="bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6 ">
                ...
                <div class="mt-5 md:col-span-2 md:mt-0">
                    ...
                    <form wire:submit.prevent="updateCurriula" class="grid grid-cols-6 gap-6">
                        @csrf
                       ...
                       <x-input.group label="Resolución"   for="resolution" clases="col-span-6 sm:col-span-4" :error="$errors->first('resolution')">
                        ...
                        <div class="col-span-6 sm:col-span-3 lg:col-span-4">
                            ...
                            <button @click="$wire.cancelForm;showFormEditAlp=false" type="button"
