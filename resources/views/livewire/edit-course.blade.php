<div x-cloak x-show="OpenFormEditCourse" x-transition:enter="ease-out duration-300"
    ...
    Livewire.on('closeModalEditCurso', message => {
        ...
        <div x-cloak x-show="OpenFormEditCourse" x-transition:enter="ease-out duration-300"
            ...
            <div
                ...
                <div lass="bg-white px-4 py-5 shadow sm:rounded-lg sm:p-6 ">
                    ...
                    <form wire:submit.prevent="updateCourse" class="space-y-8 divide-y divide-gray-200">
