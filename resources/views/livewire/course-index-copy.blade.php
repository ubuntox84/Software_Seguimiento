        ...
        >
          ...
          <div class="border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8">
            ...
            <div class="mt-4 flex sm:mt-0 sm:ml-4">
              <button @click="$wire.loadDataCursodddddd" type="button"
                  ...
                  @if (!$areaKnowledgesList->isEmpty())
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        @forelse ($areaKnowledgesList as $AreaKnowledge=>$areas)
            
                        <tr class="border-t border-gray-200 bg-gray-100 ">
                          <th colspan="7" scope="colgroup" class="px-4 py-1 text-left text-sm font-semibold text-gray-900 sm:px-6">
                            {{ $areas->name }}
                          </th>
                          <th>
                            <div class=" lg:pl-3  flex-1 items-center ">
                              ...
                              <button
                                @click.prevent="$wire.emit('loadEditFormAreaKnowledge',{{ $areas->id }});OpenFormEditArea=true"
                                type="button"
                        ...
                        <tr class="border-t border-gray-300">
                          ...
                          <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            <div class=" lg:pl-3 flex items-center ">
            
                              <button @click.prevent="$wire.emit('loadFormEditCourse',{{ $course->id }});OpenFormEditCourse=true"
                                type="button"
                                class="flex h-5 w-5 items-center justify-center rounded-full  text-green-400 hover:bg-green-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                <svg class=" h-5 w-5 text-green-400 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                  <path
                                    d="M5.433 13.917l1.262-3.155A4 4 0 017.58 9.42l6.92-6.918a2.121 2.121 0 013 3l-6.92 6.918c-.383.383-.84.685-1.343.886l-3.154 1.262a.5.5 0 01-.65-.65z" />
                              ...
                              <button @click.prenvent="$wire.deleteId({{ $course->id }},'curso');modalDelete=true" type="button"
                                class="flex h-5 w-5 items-center justify-center rounded-full  text-red-800 hover:bg-red-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                <svg class=" h-5 w-5 text-red-700 group-hover:text-gray-500" xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                  <path fill-rule="evenodd"
                                    d="M8.75 1A2.75 2.75 0 006 3.75v.443c-.795.077-1.584.176-2.365.298a.75.75 0 10.23 1.482l.149-.022.841 10.518A2.75 2.75 0 007.596 19h4.807a2.75 2.75 0 002.742-2.53l.841-10.52.149.023a.75.75 0 00.23-1.482A41.03 41.03 0 0014 4.193V3.75A2.75 2.75 0 0011.25 1h-2.5zM10 4c.84 0 1.673.025 2.5.075V3.75c0-.69-.56-1.25-1.25-1.25h-2.5c-.69 0-1.25.56-1.25 1.25v.325C8.327 4.025 9.16 4 10 4zM8.58 7.72a.75.75 0 00-1.5.06l.3 7.5a.75.75 0 101.5-.06l-.3-7.5zm4.34.06a.75.75 0 10-1.5-.06l-.3 7.5a.75.75 0 101.5.06l.3-7.5z"
                        ...
                        @empty
                        <tr class="border-t border-gray-300">
                          <td class="text-center whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
