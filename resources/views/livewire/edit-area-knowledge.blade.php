<div x-cloak x-show="OpenFormEditArea" 
    ...
    x-init="Livewire.on('closeModalEditArea', message => {
    ...
    <div class="fixed inset-0 z-10 ">
        <div x-cloak x-show="OpenFormEditArea" x-transition:enter="ease-out duration-300"
            ...
            <div class="relative py-8 px-6 transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                <div x-cloak x-show="OpenFormEditArea" class="mt-5 md:col-span-2 md:mt-0">
                    <form wire:submit.prevent="updateAreaKnowledge">
                        @csrf
