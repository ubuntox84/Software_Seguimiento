            ...
            <main class="sm:flex">
                ...
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-gray-200 sm:pl-6">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">Página no Encontrada</h1>
                        <p class="mt-1 text-base text-gray-500">Verifique la URL en la barra de direcciones e intente nuevamente.
                        </p>
                    </div>
